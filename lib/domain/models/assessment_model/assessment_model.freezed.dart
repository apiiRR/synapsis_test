...
class _$AssessmentModelImpl implements _AssessmentModel {
  ...
  @override
  String toString() {
    return 'AssessmentModel(code: $code, status: $status, page: $page, count: $count, totalData: $totalData, message: $message, data: $data)';
  }
...
abstract class _AssessmentModel implements AssessmentModel {
  factory _AssessmentModel(
      ...
      final String? message,
      final List<Datum>? data}) = _$AssessmentModelImpl;
